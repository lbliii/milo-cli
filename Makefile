...
.PHONY: all help setup install test test-cov lint lint-fix format ty clean shell docs docs-serve build publish release gh-release

all: help

help:
	@echo "Milo Development CLI"
	@echo "===================="
...
test-cov:
	uv run pytest --cov=src/milo --cov-report=term-missing
