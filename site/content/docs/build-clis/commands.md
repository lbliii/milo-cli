...
The handler's return value is serialized based on the chosen format. See [[docs/build-clis/output|Output Formatting]] for details.
...
:::{tip}
See [[docs/build-clis/groups|Command Groups]] for organizing commands into nested namespaces, [[docs/build-clis/context|Context]] for injecting execution context into handlers, and [[docs/build-clis/lazy|Lazy Loading]] for deferred imports.
:::
